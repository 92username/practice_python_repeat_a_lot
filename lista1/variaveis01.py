...
### Exercício 2:
# Atribua valores a três variáveis `a`, `b`, e `c`. Troque os valores de `a` e `b` 
...
### Exercício 4:
# Atribua uma string de texto contendo um número (por exemplo, "25") a uma variável. 
...
print(f"O preço original é {preco:.2f} reais. O valor do desconto é 25%. O preço com desconto é {preco_final:.2f} reais.")
...
print(f"A soma é {soma}, a subtração é {subtracao}, a multiplicação é {multiplicacao} e a divisão é {divisao:.2f}")
